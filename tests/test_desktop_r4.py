...
class DesktopR4Tests(unittest.TestCase):
    ...
    def test_installer_preserves_user_root_and_uses_stable_identity(self):
        ...
        self.assertIn('DestName: "app-icon-{#MyAppVersion}.ico"', script)
        self.assertIn('IconFilename: "{app}\\resources\\app-icon-{#MyAppVersion}.ico"', script)
        self.assertIn("ShouldCreateDesktopIcon", script)
