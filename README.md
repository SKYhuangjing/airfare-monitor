...
> 当前版本：v0.6.19 · Windows 10/11 x64 · 个人工具 · 每台设备最多同时启用 10 条航程

## 下载安装

- [下载航价守望 v0.6.19 安装包](https://github.com/myitheart/airfare-monitor/releases/download/v0.6.19/AirfareMonitorSetup-0.6.19.exe)
- [下载 SHA-256 校验文件](https://github.com/myitheart/airfare-monitor/releases/download/v0.6.19/AirfareMonitorSetup-0.6.19.exe.sha256)
